...
>(props: ControlProps<T, U>) {
  ...
  const {
    ControlInput: CustomControlInput,
    ControlSelect: CustomControlSelect,
    ControlApp: CustomControlApp,
  } = getComponents();
  ...
  if (prop.type.endsWith("[]")) {
    return <CustomControlSelect isCreatable={true} options={[]} />;
  }
  ...
  switch (prop.type) {
    ...
    //   return <ControlAny />
    case "app":
      return <CustomControlApp app={app!} />;
    case "boolean":
