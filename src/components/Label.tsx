...
export function Label<T extends ConfigurableProps, U extends ConfigurableProp>(
  props: LabelProps<T, U>,
) {
  ...
  return (
    ...
    <label htmlFor={id} {...getProps("label", baseStyles, props as any)}>
      {text}
    </label>
  );
}
